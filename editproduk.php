        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $tampil  =mysqli_query($koneksi, "SELECT * FROM master_produk WHERE id_produk='$id_produk'");
                    $data    =mysqli_fetch_array($tampil);
                ?>

                <!-- Begin Page Content -->
                <div class="container-fluid">
                    <form action="editproduk2.php" method="post" role="form" enctype="multipart/form-data" >  
                    <!-- Page Heading -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><input type="hidden" readonly="readonly" class="form-control" value="<?php echo $data['id_produk']?>" name="id_produk"></td>
                                        </tr>
                                        <tr>
                                            <td size="90">ID Produk</td>
                                            <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $data['id_produk']?>" name="id_produk"></td>
                                        </tr>
                                        
                                        <tr>
                                            <td>Jenis Produk</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['jenis_produk']?>" name="jenis_produk"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Produk</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nama_produk']?>" name="nama_produk" id="nama_produk"></td>
                                        </tr>
                                        ...
                                        <div class="modal-footer">
                                            <td><a href="tableproduk.php"><input type="button" class="btn btn-primary" value="Kembali"></a></td>
