...
<body id="page-top">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="404.php">NI Sampel Produk</a>
                        </div>
                    </div>
                </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Atasan</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Atasan</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Nama Atasan</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_atasan");
                                         $jumlah_data = mysqli_num_rows($sql);
                                         $total_halaman = ceil($jumlah_data / $batas);
                         
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_atasan order by id_atasan ASC limit $halaman_awal, $batas");
                                         ...
                                         <td>$data[noreg_atasan]</td>
                                         <td>$data[jabatan_atasan]</td>
                                         <td>
                                            <a href='detailatasan.php?id_atasan=$data[id_atasan]'><button class='btn btn-primary btn-xs'>Details</button></a>
                                            <a href='editatasan.php?id_atasan=$data[id_atasan]'><button class='btn btn-warning btn-xs' data-toggle='modal' data-target='#editModal'>Edit</button></a>
                                            <a href='deleteatasan.php?id_atasan=$data[id_atasan]'><button class='btn btn-danger btn-xs'>Hapus</button></a>
                                         </td>
                                         </tr>";
                                             ?>
                                             <?php
    ...
    <a class="scroll-to-top rounded" href="#page-top">
     ...
     <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="tableatasan.php" method="post" id="form_tambah" role="form" enctype="multipart/form-data" name="form_tambah">
                        <div class="modal-header" style="background:#4e73df;color:#fff;">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Data Atasan</h5>
                            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        ...
                        <table border="0" cellpadding="4">
                                    <tr>
                                        <td size="90">Kode Atasan</td>
                                        <td>
                                        <input value= "<?php
                                        $kodeauto = mysqli_query($koneksi, "SELECT max(id_atasan) as maxID from master_atasan");
                                        ...
                                        ?>" type="text" readonly="readonly" class="form-control" name="id_atasan">
                                        
                                        </td>
                                    </tr>
                                   <tr>
                                        <td>Nama Atasan</td>
                                        <td><input type="text" class="form-control" name="nama_atasan"></td>
                                    </tr>
                                    <tr>
                                        <td>No Registrasi</td>
                                        <td><input type="number" class="form-control" name="noreg_atasan" id="noreg_atasan"></td>
                                    </tr>
                                    <tr>
                                        <td>NIP</td>
                                        <td><input type="number" class="form-control" name="nip_atasan" id="nip_atasan"></td>
                                    </tr>
                                   <tr>
                                        
                                        <td>Jabatan</td>
                                        <td><select name="jabatan_atasan" class="form-control" id="jabatan_atasan">
                                        ...
                                        <option value="Asman Penjualan Retail dan e-commerce">Asman Penjualan Retail</option>
                        ...
                        <?php
                                ...
                                if(isset($_POST['simpan2'])){
                                    mysqli_query($koneksi, "INSERT INTO master_atasan set
                                    ...
                                    echo "<script>alert('Berhasil Mendambah Data Atasan'); window.location ='tableatasan.php'</script>";
                                }
                                ?>
                </div>
            </div>
