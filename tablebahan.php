...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Bahan</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Jenis Bahan</th>
                                            <th style="background:#4e73df;color:#fff;">Nama Bahan</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_bahan");
                                         $jumlah_data = mysqli_num_rows($sql);
                                         $total_halaman = ceil($jumlah_data / $batas);
                         
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_bahan order by id_bahan ASC limit $halaman_awal, $batas");
                                         ...
                                         <td>
                                            <a href='detailbahan.php?id_bahan=$data[id_bahan]'><button class='btn btn-primary btn-xs'>Details</button></a>
                                            <a href='editbahan.php?id_bahan=$data[id_bahan]'><button class='btn btn-warning btn-xs' data-toggle='modal' data-target='#editModal'>Edit</button></a>
                                            <a href='deletebahan.php?id_bahan=$data[id_bahan]'><button class='btn btn-danger btn-xs'>Hapus</button></a>
                                         </td>
                                         </tr>";
                                             ?>
                                             <?php
    ...
    <a class="scroll-to-top rounded" href="#page-top">
     ...
     <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="tablebahan.php" method="post" id="form_tambah" role="form" enctype="multipart/form-data" name="form_tambah">
                        ...
                        <table border="0" cellpadding="4">
                                    <tr>
                                        ...
                                        <td>
                                        <input value= "<?php
                                        $kodeauto = mysqli_query($koneksi, "SELECT max(id_bahan) as maxID from master_bahan");
                                        ...
                                        ?>" type="text" readonly="readonly" class="form-control" name="id_bahan">
                                        
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Bahan</td>
                                        <td><select name="jenis_bahan" class="form-control" id="jenis_bahan">
                                    ...
                                    <tr>
                                        <td>Nama Bahan</td>
                                        <td><input type="text" class="form-control" name="nama_bahan" id="nama_bahan"></td>
                                    </tr>
                        ...
                        <?php
                                ...
                                if(isset($_POST['simpan2'])){
                                    mysqli_query($koneksi, "INSERT INTO master_bahan set
                                    id_bahan = '$_POST[id_bahan]',
                                    jenis_bahan = '$_POST[jenis_bahan]',
                                    nama_bahan = '$_POST[nama_bahan]'");

                                    echo "<script>alert('Berhasil Mendambah Data Bahan'); window.location ='tablebahan.php'</script>";
                                }
                                ?>
                </div>
            </div>
