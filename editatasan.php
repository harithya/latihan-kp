        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $tampil  =mysqli_query($koneksi, "SELECT * FROM master_atasan WHERE id_atasan='$id_atasan'");
                    $data    =mysqli_fetch_array($tampil);
                ?>

                <!-- Begin Page Content -->
                <div class="container-fluid">
                    <form action="editatasan2.php" method="post" role="form" enctype="multipart/form-data" >  
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Atasan</h1>
                    <br/>
                    <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Data Atasan</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><input type="hidden" readonly="readonly" class="form-control" value="<?php echo $data['id_atasan']?>" name="id_atasan"></td>
                                        </tr>
                                        <tr>
                                            <td size="90">Kode Pegawai</td>
                                            <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $data['id_atasan']?>" name="id_atasan"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>No Reg</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['noreg_atasan']?>" name="noreg_atasan" id="noreg_atasan"></td>
                                        </tr>
                                        <tr>
                                            <td>NIP</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nip_atasan']?>" name="nip_atasan" id="nip_atasan"></td>
                                        </tr>
                                        <tr>
                                            <td>Jabatan</td>
                                            ...
                                            <option value="Asman Penjualan Retail">Asman Penjualan Retail</option>
                                        ...
                                        <div class="modal-footer">
                                            <td><a href="tableatasan.php"><input type="button" class="btn btn-primary" value="Kembali"></a></td>
