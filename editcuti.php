        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="editcuti2.php" method="post" role="form" enctype="multipart/form-data" >  
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Pegawai</h1>
                    <br/>
                    <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Data Pengajuan Cuti</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><input type="hidden" readonly="readonly" class="form-control" value="<?php echo $data['id_pengajuancuti']?>" name="id_pengajuancuti"></td>
                                        </tr>
                                        <tr>
                                            <td size="90">Kode Pegawai</td>
                                            <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $data['id_pengajuancuti']?>" name="id_pengajuancuti"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Pegawai</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nama_pegawai']?>" name="nama_pegawai"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Atasan</td>
                                        ...
                                        <tr>
                                            <td>Jumlah Hari</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['jumlah_hari']?>" name="jumlah_hari"></td>
                                        </tr>
                                        <tr>
                                            <td>Dari Tanggal</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['dari_tanggal']?>" name="dari_tanggal"></td>
                                        </tr>
                                        <tr>
                                            <td>Sampai Tanggal</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['sampai_tanggal']?>" name="sampai_tanggal"></td>
                                        </tr>
                                        <tr>
                                            <td>Alasan Cuti</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['alasan_cuti']?>" name="alasan_cuti"></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal Pengajuan</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['tanggal_pengajuancuti']?>" name="tanggal_pengajuancuti"></td>
                                        </tr>
