        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $tampil  =mysqli_query($koneksi, "SELECT * FROM master_pegawai WHERE id_pegawai='$id_pegawai'");
                    $data    =mysqli_fetch_array($tampil);
                ?>

                <!-- Begin Page Content -->
                <div class="container-fluid">
                    <form action="editpegawai2.php" method="post" role="form" enctype="multipart/form-data" >  
                    <!-- Page Heading -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><input type="hidden" readonly="readonly" class="form-control" value="<?php echo $data['id_pegawai']?>" name="id_pegawai"></td>
                                        </tr>
                                        <tr>
                                            <td size="90">Kode Pegawai</td>
                                            <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $data['id_pegawai']?>" name="id_pegawai"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>No Reg</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['no_reg']?>" name="no_reg" id="no_reg"></td>
                                        </tr>
                                        <tr>
                                            <td>NIP</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nip']?>" name="nip" id="nip"></td>
                                        </tr>
                                        <tr>
                                            <td>Golongan</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['golongan']?>" name="golongan" id="golongan"></td>
                                        </tr>
                                        <tr>
                                        <td>Jabatan</td>
                                        ...
                                        <tr>
                                            <td>Jumlah Cuti</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['jumlah_cuti']?>" name="jumlah_cuti"></td>
                                        </tr>
                                        ...
                                        <div class="modal-footer">
                                            <td><a href="tablepegawai.php"><input type="button" class="btn btn-primary" value="Kembali"></a></td>
