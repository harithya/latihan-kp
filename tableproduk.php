...
<body id="page-top">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Jenis Produk</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_produk");
                                         $jumlah_data = mysqli_num_rows($sql);
                                         $total_halaman = ceil($jumlah_data / $batas);
                         
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_produk order by id_produk ASC limit $halaman_awal, $batas");
    ...
    <a class="scroll-to-top rounded" href="#page-top">
     ...
     <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="tableproduk.php" method="post" id="form_tambah" role="form" enctype="multipart/form-data" name="form_tambah">
                        ...
                        <table border="0" cellpadding="4">
                                    <tr>
                                        <td size="90">ID Produk</td>
                                        <td>
                                        <input value= "<?php
                                        $kodeauto = mysqli_query($koneksi, "SELECT max(id_produk) as maxID from master_produk");
                                        ...
                                        ?>" type="text" readonly="readonly" class="form-control" name="id_produk">
                                        
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Produk</td>
                                        <td><select name="jenis_produk" class="form-control" id="jenis_produk">
                        ...
                        <?php
                                ...
                                if(isset($_POST['simpan2'])){
                                    mysqli_query($koneksi, "INSERT INTO master_produk set
                                    id_produk = '$_POST[id_produk]',
                                    jenis_produk = '$_POST[jenis_produk]',
                                    nama_produk = '$_POST[nama_produk]'");

                                    echo "<script>alert('Berhasil Mendambah Data Produk'); window.location ='tableproduk.php'</script>";
                                }
                                ?>
                </div>
            </div>
