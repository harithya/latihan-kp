            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tablepegawai.php">Master Data Pegawai</a>
                        <a class="collapse-item" href="tableatasan.php">Master Data Atasan</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tableizincuti.php">Pengajuan Izin Cuti</a>
                        <a class="collapse-item" href="404.php">Pengajuan Izin Lainnya</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                    ...
                    <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="tablenirebag.php">NI SPK Rebagging</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Nota Intern Permohonan Sampel Produk</h1>
                    <a href="tambahnisampel.php" style="margin-right :0.5pc;" 
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Tanggal</th>
                                            <th style="background:#4e73df;color:#fff;">Nomor Nota Intern</th>
                                            <th style="background:#4e73df;color:#fff;">Gudang</th>
                                            <th style="background:#4e73df;color:#fff;">Perihal</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_nisampel");
                                         $jumlah_data = mysqli_num_rows($sql);
                                         $total_halaman = ceil($jumlah_data / $batas);
                         
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_nisampel order by id_sampel ASC limit $halaman_awal, $batas");
                                         $nomor = $halaman_awal+1;
                                                       
                                         while($data=mysqli_fetch_array($tampil)){

                                         $bulanaja = date('m',strtotime($data['tanggal_sampel']));
                                         $tanggalindo = date('d-m-Y',strtotime($data['tanggal_sampel']));
                                            
                                         echo"<tr>
                                         <td>$nomor</td>
                                         <td>$tanggalindo</td>
                                         <td>NI-$data[no_ni]/10A03/$bulanaja/2022</td>
                                         <td>$data[gudang_sampel]</td>  
                                         <td>$data[hal_sampel]</td>
                                                                                  
                                         <td>
                                            <a href='detailnisampel.php?id_sampel=$data[id_sampel]'><button class='btn btn-primary btn-xs'>Details</button></a>
                                            <a href='editnisampel.php?id_sampel=$data[id_sampel]'><button class='btn btn-warning btn-xs' data-toggle='modal' data-target='#editModal'>Edit</button></a>
                                            <a href='deletenisampel.php?id_sampel=$data[id_sampel]'><button class='btn btn-danger btn-xs'>Hapus</button></a>
                                            <a href='suratnisampel.php?id_sampel=$data[id_sampel]'><button class='btn btn-danger btn-xs'>Print</button></a>
                                         </td>
                                         </tr>";
                                             ?>
                                             <?php
