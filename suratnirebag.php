...
// untuk melakukan looping banyak page hasus di bungkus fungsi 
// $pdf->AddPage();
// pada perulangan , saya contohnya pke for untuk inisialiasi new FPDF nya diluar perulangan dan  fungsi $pdf->Output();
// diluar perulangan di bawahnya
