...
<head>
    ...
    <title>Detail Data NI Rebagging</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Detail NI Rebagging</h1>
                    <br/>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data NI Rebagging</h6>
                        </div>
                        <div class="card-body">
                        <div class="table-responsive">
                            <table border="0" cellpadding="4">
                                <tr>
                                    ...
                                    <td>: <?php echo $data['id_rebag']?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Pengajuan</td>
                                    <td>: <?php echo $data['tanggal_rebag']?></td>
                                </tr>
                                <tr>
                                    <td>Nama Produk</td>
                                ...
                                <tr>
                                    <td>Gudang</td>
                                    <td>: <?php echo $data['gudang_rebag']?></td>
                                </tr>
                                <tr>
                                    <td>Koli</td>
                                    <td>: <?php echo $data['koli_rebag']?></td>
                                </tr>
                                <tr>
                                    <td>Kuantum</td>
                                    <td>: <?php echo $data['kuantum_rebag']?></td>
                                </tr>
                                <tr>
                                    <td>Kemasan Sebelum</td>
                                    <td>: <?php echo $data['kemasansebelum_rebag']?></td>
                                </tr>
