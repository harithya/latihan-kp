        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Izin Cuti</h1>
                    <a href="tambahcuti.php" style="margin-right :0.5pc;" 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Izin Cuti</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Jumlah Hari</th>
                                            <th style="background:#4e73df;color:#fff;">Dari Tanggal</th>
                                            <th style="background:#4e73df;color:#fff;">Sampai Tanggal</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_cuti");
                                         ...
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_cuti INNER JOIN master_pegawai ON master_cuti.nama_pegawai = master_pegawai.id_pegawai
                                                                                                  INNER JOIN master_atasan ON master_cuti.nama_atasan = master_atasan.id_atasan 
                                                                                                  order by id_pengajuancuti ASC limit $halaman_awal, $batas");
                                         $nomor = $halaman_awal+1;
                                                       
                                         while($data=mysqli_fetch_array($tampil)){

                                        $bulanaja = date('m',strtotime($data['tanggal_pengajuancuti']));
                                        $tanggalindo1 = date('d-m-Y',strtotime($data['tanggal_pengajuancuti'])); 
                                        $tanggalindo2 = date('d-m-Y',strtotime($data['dari_tanggal'])); 
                                        $tanggalindo3 = date('d-m-Y',strtotime($data['sampai_tanggal'])); 
                                         ...
                                         <td>
                                            <a href='detailcuti.php?id_pengajuancuti=$data[id_pengajuancuti]'><button class='btn btn-primary btn-xs'>Details</button></a>
                                            <a href='editcuti.php?id_pengajuancuti=$data[id_pengajuancuti]'><button class='btn btn-warning btn-xs' data-toggle='modal' data-target='#editModal'>Edit</button></a>
                                            <a href='deletecuti.php?id_pengajuancuti=$data[id_pengajuancuti]'><button class='btn btn-danger btn-xs'>Hapus</button></a>
                                            <a href='suratcuti.php?id_pengajuancuti=$data[id_pengajuancuti]'><button class='btn btn-danger btn-xs'>Print</button></a>
                                         </td>
                                         </tr>";
                                             ?>
                                             <?php
