        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Nota Intern Rebagging</h1>
                    <a href="tambahnirebag.php" style="margin-right :0.5pc;" 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel Data NI Rebagging</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead >
                                        <tr>
                                            ...
                                            <th style="background:#4e73df;color:#fff;">Nomor Nota Inten</th>
                                            <th style="background:#4e73df;color:#fff;">Gudang</th>
                                            <th style="background:#4e73df;color:#fff;">Produk</th>
                                        ...
                                        <?php
                                         ...
                                         $sql=mysqli_query($koneksi,"SELECT * FROM master_nirebag");
                                         ...
                                         $tampil=mysqli_query($koneksi,"SELECT * FROM master_nirebag INNER JOIN master_produk ON master_nirebag.nama_produk = master_produk.id_produk
                                                                                                     ...
                                                                                                     order by id_rebag ASC limit $halaman_awal, $batas");
                                         $nomor = $halaman_awal+1;
                                                       
                                         while($data=mysqli_fetch_array($tampil)){

                                         $bulanaja = date('m',strtotime($data['tanggal_rebag']));   
                                         $tanggalindo = date('d-m-Y',strtotime($data['tanggal_rebag']));  

                                         echo"<tr>
                                         <td>$nomor</td>
                                         <td>$tanggalindo</td>
                                         <td>NI-$data[no_ni]/10A03/$bulanaja/2022</td>
                                         <td>$data[gudang_rebag]</td>  
                                         <td>$data[nama_produk]</td>
                                        
                                         
                                         <td>
                                            <a href='detailnirebag.php?id_rebag=$data[id_rebag]'><button class='btn btn-primary btn-xs'>Details</button></a>
                                            <a href='editnirebag.php?id_rebag=$data[id_rebag]'><button class='btn btn-warning btn-xs' data-toggle='modal' data-target='#editModal'>Edit</button></a>
                                            <a href='deletenirebag.php?id_rebag=$data[id_rebag]'><button class='btn btn-danger btn-xs'>Hapus</button></a>
                                            <a href='suratnirebag.php?id_rebag=$data[id_rebag]'><button class='btn btn-danger btn-xs'>Print</button></a>
                                         </td>
                                         </tr>";
                                             ?>
                                             <?php
