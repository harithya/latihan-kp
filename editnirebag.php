...
<head>
    ...
    <title>Edit Data NI Rebag</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="editnirebag.php" method="post" role="form" enctype="multipart/form-data" >  
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data NI Rebagging</h1>
                    <br/>
                    <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Data NI Rebagging</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><input type="hidden" readonly="readonly" class="form-control" value="<?php echo $data['id_rebag']?>" name="id_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td size="90">ID Rebagging</td>
                                            <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $data['id_rebag']?>" name="id_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Tanggal Pengajuan</td>
                                            <td><input type="date" class="form-control" value="<?php echo $data['tanggal_rebag']?>" name="tanggal_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Produk</td>
                                        ...
                                        <tr>
                                            <td>Nama Bahan</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nama_bahan']?>" name="bahan_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Kemasan Sebelum</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['kemasansebelum_rebag']?>" name="kemasansebelum_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Kemasan Sesudah</td>
                                            <td><input type="number" class="form-control" value="<?php echo $data['kemasansesudah_rebag']?>" name="kemasansesudah_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Jumlah Koli</td>
                                            <td><input type="number" class="form-control" value="<?php echo $data['koli_rebag']?>" name="koli_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Jumlah Kuantum</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['kuantum_rebag']?>" name="kuantum_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Gudang</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['gudang_rebag']?>" name="gudang_rebag"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Atasan</td>
                                            <td><input type="text" class="form-control" value="<?php echo $data['nama_atasan']?>" name="nama_atasan"></td>
                                        </tr>
